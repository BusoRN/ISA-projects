...
/*****************************************************************/
	...
	{
		sc_int<Gbit> C0_Estesa = 0;		// Guard bits to realize a correct sum
		C0_Estesa.range(Cbit-1, 0) = C0;
		sc_int<Gbit> C1_Estesa = 0;
		C1_Estesa.range(Cbit-1, 0) = C1;
		g3_i.write( C0_Estesa + C1_Estesa);
		g1_i.write(C0_Estesa);
		g2_i.write(C1_Estesa);
	...
	{
		sc_int<Abit> g1_Estesa = 0;
		g1_Estesa.range(Gbit-1, 0) = g1.read();
		sc_int<Abit> Temp =g1_Estesa + a3_reg.read();
	...
	{
		sc_int<Abit> g2_Estesa = 0;
		g2_Estesa.range(Gbit-1, 0) = g2.read();
		sc_int<Abit> Temp = g2_Estesa + a1_reg.read();
	...
	void ACS4::as_beh_a2_tpd ( void )
	{
		...
		sc_int<Abit> g1_Estesa = 0;
		g1_Estesa.range(Gbit-1, 0) = g1.read();
		sc_int<Abit> Temp = g1_Estesa + a1_reg.read();
	...
	void ACS4::as_beh_a3_tpd ( void )
	{
		sc_int<Abit> g2_Estesa = 0;
		g2_Estesa.range(Gbit - 1, 0) = g2.read();
		sc_int<Abit> Temp = g2_Estesa + a3_reg.read();
	...
	{
		sc_int<Abit> g3_Estesa = 0;
		g3_Estesa.range(Gbit-1, 0) = g3.read();
		sc_int<Abit> Temp = g3_Estesa + a0_reg.read();
	...
	void ACS4::as_beh_a5_tpd ( void )
	{
		sc_int<Abit> g3_Estesa = 0;
		g3_Estesa.range(Gbit-1, 0) = g3.read();
		sc_int<Abit> Temp = g3_Estesa + a2_reg.read();
